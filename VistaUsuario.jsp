                ...
                <div class="modal-body">
                    <div class="accordion" id="accordionDocumentos">
                        <div class="accordion-item panelImagen">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaFactura"
                                ...
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" value="factura" id="btnIdentificacion"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                <button name="gFactura" type="submit"
                                                    class="botonGuardar btn btn-primary col-2 btn-sm" id="imgFactura">
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaSecuencia"
                                onsubmit="return userSubmit()">
                                    ...
                                    <div id="imagenSecuencia" class="accordion-body">
                                        <div class="row">
                                            <div class="mb-0 col-10">
                                                ...
                                                <input class="form-control" type="file" name="imagen" />
                                                <input type="hidden" class="idsOcultos" name="fkImagenes" id="cargaS" />
                                            </div>
                                            <div class="btn-group col-2" role="group">
                                                <button name="gSecuencia" type="submit"
                                                    class="botonGuardar btn btn-primary col-2 btn-sm" id="imgSecuencia">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                            ...
                            <iframe id="iFrameSecuencia" src="" width="100%" height="500px" frameborder="0"></iframe>
                            <img id="imgSecuenciaVer" class="img-fluid" src="" alt="" />
                        </div>
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaCertificado"
                                onsubmit="return userSubmit()">
                            ...
                            <iframe id="iFrameCertificado" src="" width="100%" height="500px" frameborder="0"></iframe>
                            <img id="imgCertificadoVer" class="img-fluid" src="" alt="" />
                        </div>
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post"
                                id="cargaCopiaCertificado" onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaImportacion"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                            ...
                            <iframe id="iFrameImportacion" src="" width="100%" height="500px" frameborder="0"></iframe>
                            <img id="imgImportacionVer" class="img-fluid" src="" alt="" />
                        </div>
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaPermiso"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                <button name="gPermiso" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm" id="imgPermiso">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaRFV"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post"
                                id="cargaVerificacion" onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                                    <button value="R.F.V." id="btnVerificacion" class="accordion-button collapsed"
                            ...
                            <iframe id="iFrameVerificacion" src="" width="100%" height="500px" frameborder="0"></iframe>
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post"
                                id="cargaFacturaMotor" onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                            ...
                            <iframe id="iFrameFacturaMotor" src="" width="100%" height="500px" frameborder="0"></iframe>
                            <img id="imgFacturaMotorVer" class="img-fluid" src="" alt="" />
                        </div>
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaLlaves"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaConoce"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaLFPDPPP"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-2" role="group">
                                                <button name="gLFPDPPP" type="submit"
                                                    class="botonGuardar btn btn-primry col-2 btn-sm" id="imgLFPDPPP">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post"
                                id="cargaAveriguacion" onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                            ...
                            <iframe id="iFrameAveriguacion" src="" width="100%" height="500px" frameborder="0"></iframe>
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaAviso"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                                    <button value="Aviso" id="btnAviso" class="accordion-button collapsed" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#Averiguacion" aria-expanded="false"
                                        aria-controls="collapseThree">
                                        Aviso a PFP
                                    </button>
                                </h2>
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaOtros"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post" id="cargaOficio"
                                onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
                        ...
                        <div class="accordion-item">
                            <form class="formImagenes" enctype="multipart/form-data" method="post"
                                id="cargaOficioCancelacion" onsubmit="return userSubmit()">
                                <h2 class="accordion-header" id="headingThree">
