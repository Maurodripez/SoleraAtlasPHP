                ...
                <div class="modal-body">
                    <div class="accordion" id="accordionDocumentos">
                        ...
                        <div class="col">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button value="Formato finiquito" id="btnFiniquito"
                                        class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#Finiquito" aria-expanded="false" aria-controls="collapseThree">
                                        Formato finiquito
                                    </button>
                                </h2>
                                <div id="Finiquito" class="accordion-collapse collapse" aria-labelledby="headingThree">
                                    <div id="imagenFiniquito" class="accordion-body">
                                        <div class="row">
                                            <div class="file-select botonCargarDoc col-8">
                                                <input class="form-control form-control-sm" type="file"
                                                    id="inputFiniquito" multiple="" />
                                            </div>
                                            <div class="btn-group col-4" role="group">
                                                <button onclick="subirImagen(this.id)" name="gFiniquito" type="submit"
                                                    class="botonGuardar btn btn-success col-2 btn-sm" id="imgFiniquito">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a id="btnListaFiniquito"
                                                    onclick="mostrarImagenFrame('ulFiniquito','Formato finiquito')"
                                                    class="btn btn-primary col-2 btn-sm" data-bs-toggle="collapse"
                                                    href="#collapseFiniquito" role="button" aria-expanded="false"
                                                    aria-controls="collapseExample">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                                        <path
                                            ...
                                            <div class="collapse" id="collapseFiniquito">
                                                <div class="card card-body">
                                                    <ul id="ulFiniquito" class="list-group">
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingThree">
                                    <button value="Formato refactura" id="btnRefactura"
                                        class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#Refactura" aria-expanded="false" aria-controls="collapseThree">
                                        Formato refactura
                                    </button>
                                </h2>
                                <div id="Refactura" class="accordion-collapse collapse" aria-labelledby="headingThree">
                                    <div id="imagenRefactura" class="accordion-body">
                                        <div class="row">
                                            <div class="file-select botonCargarDoc col-8">
                                                <input class="form-control form-control-sm" type="file"
                                                    id="inputRefactura" multiple="" />
                                            </div>
                                            <div class="btn-group col-4" role="group">
                                                <button onclick="subirImagen(this.id)" name="gRefactura" type="submit"
                                                    class="botonGuardar btn btn-success col-2 btn-sm" id="imgRefactura">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a id="btnListaRefactura"
                                                    onclick="mostrarImagenFrame('ulRefactura','Formato refactura')"
                                                    class="btn btn-primary col-2 btn-sm" data-bs-toggle="collapse"
                                                    href="#collapseRefactura" role="button" aria-expanded="false"
                                                    aria-controls="collapseExample">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                                        <path
                        ...
                        <div class="col">
                            <div class="accordion-item">
                                ...
                                <div id="Cedula" class="accordion-collapse collapse" aria-labelledby="headingThree">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="btn-group col-4" role="group">
                                                <button onclick="subirImagen(this.id)" name="gCedula" type="submit"
                                                    class="botonGuardar btn btn-success col-2 btn-sm" id="imgCedula">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-cloud-arrow-up"
                                                        viewBox="0 0 16 16">
                                                        <path fill-rule="evenodd"
                                                ...
                                                <a id="btnListaCedula"
                                                    onclick="mostrarImagenFrame('ulCedula','Cedula corta')"
                                                    class="btn btn-primary col-2 btn-sm" data-bs-toggle="collapse"
                                                    href="#collapseCedula" role="button" aria-expanded="false"
                                                    aria-controls="collapseExample">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                        fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                                        <path
                                            ...
                                            <div class="collapse" id="collapseCedula">
                                                <div class="card card-body">
                                                    <ul id="ulCedula" class="list-group">
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
